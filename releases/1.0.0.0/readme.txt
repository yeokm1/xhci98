...
xhci98.inf names FIVE files. Look in the same directory as this readme, in
release\ and in debug\, and check all five are there:

      xhci98.inf   xhci98.sys   usbd98.sys   usbd2k.sys   usbhub98.sys

IF ALL FIVE ARE PRESENT, skip to step 4. Nothing to do. That is what the
...
project's SOURCE REPOSITORY, which does not carry the other three. Read on.
...
three are copied with "do not overwrite", so nothing of yours is replaced.

COMPLETING A COPY TAKEN FROM THE REPOSITORY
...........................................

From a clone, all three are staged from your own Windows install media and
...
Install from out\pkg-release\ - that directory has all five files. The
...
==============================================================================
  ...
  The normal driver. This is the one you want.
      ...
      xhci98.inf
      xhci98.sys   82,507 bytes
      SHA-256
      1EB279A1907395FF0C0BE0CB7FDBD924AE8718818236E7182678976C50C06450

  ...and beside them, the other three files step 3 names, which
  the download carries and a copy from the repository does not:

      usbd98.sys     Windows 98 SE's own USBD.SYS, 4.10.2222
      usbd2k.sys     Windows 2000 SP4's own USBD.SYS, 5.00.2195.6658
      usbhub98.sys   Windows 98 SE's own USBHUB.SYS, 4.10.2222
  ...
  XHCISNAP, so you do not need this one to send a report.
      ...
      xhci98.inf
      xhci98.sys   83,115 bytes
      SHA-256
      44D95C1ABFC3740B22AB408E9F07AD7272B7F32BF6F95F11883EBAADC9A88698
...
1.0.0.0, so a copy taken out of its directory cannot be identified by name
...
repository rather than here. Section 5 covers those three files.
