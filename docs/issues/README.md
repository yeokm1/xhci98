...
found. Issue 4 is open: a potential issue observed once on the Windows XP
guest, recorded with its candidate cause; its fix is roadmap task 19.7 in
release `1.0.0.2`.
